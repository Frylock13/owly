...
Setting.create(key: 'vkontakte_link', value: 'http://localhost:3000')
Setting.create(key: 'facebook_link', value: 'http://localhost:3000')
Setting.create(key: 'twitter_link', value: 'http://localhost:3000')
Setting.create(key: 'instagram_link', value: 'http://localhost:3000')
